      ...
      _export("default", ScrollHelper = (_dec = property(Node), _dec2 = property(ScrollView), ccclass(_class = (_class2 = class ScrollHelper extends Component {
        ...
        onLoad() {
          ...
          return _asyncToGenerator(function* () {
            ...
            _this.visibleHeight = _this.scroll.node.getComponent(UITransform).height;
        ...
        loadList() {
          ...
          var uITransform = this.viewContent.getComponent(UITransform);
        ...
        onRefresh(obj, idx, objIdx) {
          ...
          var num = obj.getChildByName("index").getComponent(Label); // head.spriteFrame = this.headList[objIdx];
